...
namespace T0NKME06.Models
{
    public class T0NKME07model
    {
        ...
        [Display(Name = "管束外部腐蝕率")]
        public string BundleExtCorrRate { get; set; }
        [Display(Name = "管束內部腐蝕率")]
        public string BundleIntCorrRate { get; set; }
        [Display(Name = "偵測時間")]
        ...
        [Display(Name = "估計最小厚度2")]
        public double EstMinThickness2 { get; set; }
        [Display(Name = "估計半壽命")]
        ...
        public double ExtCalcCorrRate1 { get; set; }
